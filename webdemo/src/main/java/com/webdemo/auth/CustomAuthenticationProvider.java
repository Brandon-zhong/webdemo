...
public class CustomAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        System.err.println("com.webdemo.auth.CustomAuthenticationProvider.authenticate--> " + id + "  " + pwd);
        ...
        System.out.println(dbPassword + " -- " + pwd);

        if (!dbPassword.equals(pwd)) {
            System.err.println("com.webdemo.auth.CustomAuthenticationProvider.authenticate--> 密码错误");
...
//        authorities.add(new SimpleGrantedAuthority(""));
        ...
        Authentication auth = new UsernamePasswordAuthenticationToken(id, pwd, userDetails.getAuthorities());
